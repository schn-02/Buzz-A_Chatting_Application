...
Buzz is a real-time Android chat application built using **Java, XML, Firebase, and MVVM architecture**.  
It allows users to sign up, log in, view other users, and chat in real time with a clean and responsive UI.
